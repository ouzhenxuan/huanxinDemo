...
- (id)initWithMessageModel:(MessageModel *)model reuseIdentifier:(NSString *)reuseIdentifier//设置子控件的内容
{
    ...
    if (self) {
        ...
        if (model.isSender) {//如果是发送者
            originX = self.bounds.size.width - HEAD_SIZE - HEAD_PADDING;//  = 320  -40-5 == 275
        }
...
-(void)layoutSubviews//设置子控件的最终位置
{
...
- (void)setMessageModel:(MessageModel *)messageModel
{
    ...
    _headImageView.image = placeholderImage;
